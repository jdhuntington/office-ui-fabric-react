...
const ListBasicExampleCode = require('!raw-loader!@uifabric/core/src/components/List/examples/List.Basic.Example.tsx') as string;
const ListGridExampleCode = require('!raw-loader!@uifabric/core/src/components/List/examples/List.Grid.Example.tsx') as string;
const ListScrollingExampleCode = require('!raw-loader!@uifabric/core/src/components/List/examples/List.Scrolling.Example.tsx') as string;
const ListGhostingExampleCode = require('!raw-loader!@uifabric/core/src/components/List/examples/List.Ghosting.Example.tsx') as string;
const ListGhostingExampleCodepen = require('!@uifabric/codepen-loader!@uifabric/core/src/components/List/examples/List.Ghosting.Example.tsx') as string;
...
export const ListPageProps: IDocPageProps = {
  ...
  overview: require<string>('!raw-loader!@uifabric/core/src/components/List/docs/ListOverview.md'),
