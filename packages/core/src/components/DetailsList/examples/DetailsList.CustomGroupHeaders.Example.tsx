...
import { DetailsList, IGroup, IGroupDividerProps } from '@uifabric/core/lib/DetailsList';
import { createListItems, createGroups, IExampleItem } from '@uifabric/core/lib/utilities/exampleData';
import { getTheme, mergeStyleSets } from '@uifabric/core/lib/Styling';
import { DEFAULT_ROW_HEIGHTS } from '@uifabric/core/lib/components/DetailsList/DetailsRow.styles';
