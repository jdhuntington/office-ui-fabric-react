...
import { MessageBarButton } from '@uifabric/core/lib/Button';
import { Link } from '@uifabric/core/lib/Link';
import { Label } from '@uifabric/core/lib/Label';
import { Stack, StackItem } from '@uifabric/core/lib/Stack';
import { MessageBar, MessageBarType } from '@uifabric/core/lib/MessageBar';

const log = (text: string): (() => void) => (): void => console.log(text);

export const MessageBarStyledExample: React.StatelessComponent = () => (
  <Stack tokens={{ childrenGap: 20 }}>
    ...
    <StackItem>
      ...
      <MessageBar
        styles={{ actions: { background: '#007d84', border: '1px solid #ffb900' } }}
        actions={
          <div>
