...
const DialogBasicExampleCode = require('!raw-loader!@uifabric/core/src/components/Dialog/examples/Dialog.Basic.Example.tsx') as string;
const DialogBasicExampleCodepen = require('!@uifabric/codepen-loader!@uifabric/core/src/components/Dialog/examples/Dialog.Basic.Example.tsx') as string;
const DialogLargeHeaderExampleCode = require('!raw-loader!@uifabric/core/src/components/Dialog/examples/Dialog.LargeHeader.Example.tsx') as string;
const DialogLargeHeaderExampleCodepen = require('!@uifabric/codepen-loader!@uifabric/core/src/components/Dialog/examples/Dialog.LargeHeader.Example.tsx') as string;
const DialogBlockingExampleCode = require('!raw-loader!@uifabric/core/src/components/Dialog/examples/Dialog.Blocking.Example.tsx') as string;
const DialogBlockingExampleCodepen = require('!@uifabric/codepen-loader!@uifabric/core/src/components/Dialog/examples/Dialog.Blocking.Example.tsx') as string;
const DialogTopOffsetFixedExampleCode = require('!raw-loader!@uifabric/core/src/components/Dialog/examples/Dialog.TopOffsetFixed.Example.tsx') as string;
const DialogTopOffsetFixedExampleCodepen = require('!@uifabric/codepen-loader!@uifabric/core/src/components/Dialog/examples/Dialog.TopOffsetFixed.Example.tsx') as string;
const DialogModelessExampleCode = require('!raw-loader!@uifabric/core/src/components/Dialog/examples/Dialog.Modeless.Example.tsx') as string;
const DialogModelessExampleCodepen = require('!@uifabric/codepen-loader!@uifabric/core/src/components/Dialog/examples/Dialog.Modeless.Example.tsx') as string;
...
export const DialogPageProps: IDocPageProps = {
  ...
  overview: require<string>('!raw-loader!@uifabric/core/src/components/Dialog/docs/DialogOverview.md'),
  bestPractices: '',
  dos: require<string>('!raw-loader!@uifabric/core/src/components/Dialog/docs/DialogDos.md'),
  donts: require<string>('!raw-loader!@uifabric/core/src/components/Dialog/docs/DialogDonts.md'),
