...
const ContextualMenuBasicExampleCode = require('!raw-loader!@uifabric/core/src/components/ContextualMenu/examples/ContextualMenu.Basic.Example.tsx') as string;
const ContextualMenuPersistedExampleCode = require('!raw-loader!@uifabric/core/src/components/ContextualMenu/examples/ContextualMenu.Persisted.Example.tsx') as string;
const ContextualMenuBasicExampleCodepen = require('!@uifabric/codepen-loader!@uifabric/core/src/components/ContextualMenu/examples/ContextualMenu.Basic.Example.tsx') as string;
const ContextualMenuIconExampleCode = require('!raw-loader!@uifabric/core/src/components/ContextualMenu/examples/ContextualMenu.Icon.Example.tsx') as string;
const ContextualMenuIconSecondaryTextExampleCode = require('!raw-loader!@uifabric/core/src/components/ContextualMenu/examples/ContextualMenu.Icon.SecondaryText.Example.tsx') as string;
const ContextualMenuSubmenuExampleCode = require('!raw-loader!@uifabric/core/src/components/ContextualMenu/examples/ContextualMenu.Submenu.Example.tsx') as string;
const ContextualMenuSectionExampleCode = require('!raw-loader!@uifabric/core/src/components/ContextualMenu/examples/ContextualMenu.Section.Example.tsx') as string;
const ContextualMenuCheckmarksExampleCode = require('!raw-loader!@uifabric/core/src/components/ContextualMenu/examples/ContextualMenu.Checkmarks.Example.tsx') as string;
const ContextualMenuDirectionalExampleCode = require('!raw-loader!@uifabric/core/src/components/ContextualMenu/examples/ContextualMenu.Directional.Example.tsx') as string;
const ContextualMenuCustomizationExampleCode = require('!raw-loader!@uifabric/core/src/components/ContextualMenu/examples/ContextualMenu.Customization.Example.tsx') as string;
const ContextualMenuCustomizationWithNoWrapExampleCode = require('!raw-loader!@uifabric/core/src/components/ContextualMenu/examples/ContextualMenu.CustomizationWithNoWrap.Example.tsx') as string;
const ContextualMenuWithScrollBarExampleCode = require('!raw-loader!@uifabric/core/src/components/ContextualMenu/examples/ContextualMenu.ScrollBar.Example.tsx') as string;
const ContextualMenuWithCustomMenuItemExampleCode = require('!raw-loader!@uifabric/core/src/components/ContextualMenu/examples/ContextualMenu.CustomMenuItem.Example.tsx') as string;
const ContextualMenuCustomMenuListExampleCode = require('!raw-loader!@uifabric/core/src/components/ContextualMenu/examples/ContextualMenu.CustomMenuList.Example.tsx') as string;
const ContextualMenuHeaderExampleCode = require('!raw-loader!@uifabric/core/src/components/ContextualMenu/examples/ContextualMenu.Header.Example.tsx') as string;
...
export const ContextualMenuPageProps: IDocPageProps = {
  ...
  overview: require<string>('!raw-loader!@uifabric/core/src/components/ContextualMenu/docs/ContextualMenuOverview.md'),
  bestPractices: '',
  dos: require<string>('!raw-loader!@uifabric/core/src/components/ContextualMenu/docs/ContextualMenuDos.md'),
  donts: require<string>('!raw-loader!@uifabric/core/src/components/ContextualMenu/docs/ContextualMenuDonts.md'),
