...
import { AnimationClassNames } from '@uifabric/core/lib/Styling';
import { BaseComponent, css } from '@uifabric/core/lib/Utilities';
import { Layer } from '@uifabric/core/lib/Layer';
