...
const ResizeGroupBasicExampleCode = require('!raw-loader!@uifabric/core/src/components/ResizeGroup/examples/ResizeGroup.OverflowSet.Example.tsx') as string;

const ResizeGroupVerticalExampleCode = require('!raw-loader!@uifabric/core/src/components/ResizeGroup/examples/ResizeGroup.VerticalOverflowSet.Example.tsx') as string;

const ResizeGroupFlexBoxExampleCode = require('!raw-loader!@uifabric/core/src/components/ResizeGroup/examples/ResizeGroup.FlexBox.Example.tsx') as string;
...
export const ResizeGroupPageProps: IDocPageProps = {
  ...
  overview: require<string>('!raw-loader!@uifabric/core/src/components/ResizeGroup/docs/ResizeGroupOverview.md'),
  bestPractices: '',
  dos: require<string>('!raw-loader!@uifabric/core/src/components/ResizeGroup/docs/ResizeGroupDos.md'),
  donts: require<string>('!raw-loader!@uifabric/core/src/components/ResizeGroup/docs/ResizeGroupDonts.md'),
