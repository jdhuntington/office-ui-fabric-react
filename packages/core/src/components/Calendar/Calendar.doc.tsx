...
import { addMonths, addYears, addWeeks, addDays } from '@uifabric/core/lib/utilities/dateMath/DateMath';

const CalendarButtonExampleCode = require('!raw-loader!@uifabric/core/src/components/Calendar/examples/Calendar.Button.Example.tsx') as string;
const CalendarInlineExampleCode = require('!raw-loader!@uifabric/core/src/components/Calendar/examples/Calendar.Inline.Example.tsx') as string;
...
export const CalendarPageProps: IDocPageProps = {
  ...
  overview: require<string>('!raw-loader!@uifabric/core/src/components/Calendar/docs/CalendarOverview.md'),
  bestPractices: '',
  dos: require<string>('!raw-loader!@uifabric/core/src/components/Calendar/docs/CalendarDos.md'),
  donts: require<string>('!raw-loader!@uifabric/core/src/components/Calendar/docs/CalendarDonts.md'),
