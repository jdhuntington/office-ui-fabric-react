...
import { IPersonaProps } from '@uifabric/core/lib/Persona';
import { ExtendedPeoplePicker } from '@uifabric/core/lib/ExtendedPicker';
import { PrimaryButton } from '@uifabric/core/lib/Button';
import {
  SuggestionsStore,
  FloatingPeoplePicker,
  IBaseFloatingPickerProps,
  IBaseFloatingPickerSuggestionProps
} from '@uifabric/core/lib/FloatingPicker';
import { ISelectedPeopleProps, SelectedPeopleList, IExtendedPersonaProps } from '@uifabric/core/lib/SelectedItemsList';
import { IFocusZoneProps, FocusZoneTabbableElements } from '@uifabric/core/lib/FocusZone';
import { mergeStyleSets, getTheme, IStyle, IProcessedStyleSet } from '@uifabric/core/lib/Styling';
