...
import { ColorPicker, Toggle, getColorFromString, IColor } from '@uifabric/core/lib/index';
import { mergeStyleSets, HighContrastSelector } from '@uifabric/core/lib/Styling';
import { updateA } from '@uifabric/core/lib/utilities/color/updateA';
