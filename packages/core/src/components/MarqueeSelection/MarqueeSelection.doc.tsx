...
const MarqueeSelectionBasicExampleCode = require('!raw-loader!@uifabric/core/src/components/MarqueeSelection/examples/MarqueeSelection.Basic.Example.tsx') as string;
export const MarqueeSelectionPageProps: IDocPageProps = {
  ...
  overview: require<string>('!raw-loader!@uifabric/core/src/components/MarqueeSelection/docs/MarqueeSelectionOverview.md'),
  bestPractices: '',
  dos: '',
  donts: '',
