...
const SelectionBasicExampleCode = require('!raw-loader!@uifabric/core/src/utilities/selection/examples/Selection.Basic.Example.tsx') as string;
...
export const SelectionPageProps: IDocPageProps = {
  ...
  overview: require<string>('!raw-loader!@uifabric/core/src/utilities/selection/docs/SelectionOverview.md'),
