...
import { ITextFieldStyleProps, ITextFieldStyles, TextField } from '@uifabric/core/lib/TextField';
import { ILabelStyles, ILabelStyleProps } from '@uifabric/core/lib/Label';
