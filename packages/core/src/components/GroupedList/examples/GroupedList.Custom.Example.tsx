...
import { GroupedList, IGroup, IGroupHeaderProps, IGroupFooterProps } from '@uifabric/core/lib/GroupedList';
...
import { getTheme, mergeStyleSets, IRawStyle } from '@uifabric/core/lib/Styling';
