...
import { MainPanelContentWrapper, MainPanelInnerContent } from '../shared/MainPanelStyles';
...
export class Samples extends React.Component<ISamplesProps, {}> {
  public render() {
    return (
      <div className={MainPanelContentWrapper} style={{ backgroundColor: this.props.backgroundColor }}>
