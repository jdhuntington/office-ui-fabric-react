...
const DocumentCardBasicExampleCode = require('!raw-loader!@uifabric/core/src/components/DocumentCard/examples/DocumentCard.Basic.Example.tsx') as string;
const DocumentCardBasicExampleCodepen = require('!@uifabric/codepen-loader!@uifabric/core/src/components/DocumentCard/examples/DocumentCard.Basic.Example.tsx') as string;
const DocumentCardCompactExampleCode = require('!raw-loader!@uifabric/core/src/components/DocumentCard/examples/DocumentCard.Compact.Example.tsx') as string;
const DocumentCardCompactExampleCodepen = require('!@uifabric/codepen-loader!@uifabric/core/src/components/DocumentCard/examples/DocumentCard.Compact.Example.tsx') as string;
const DocumentCardCompleteExampleCode = require('!raw-loader!@uifabric/core/src/components/DocumentCard/examples/DocumentCard.Complete.Example.tsx') as string;
const DocumentCardCompleteExampleCodepen = require('!@uifabric/codepen-loader!@uifabric/core/src/components/DocumentCard/examples/DocumentCard.Complete.Example.tsx') as string;
const DocumentCardImageExampleCode = require('!raw-loader!@uifabric/core/src/components/DocumentCard/examples/DocumentCard.Image.Example.tsx') as string;
const DocumentCardImageExampleCodepen = require('!@uifabric/codepen-loader!@uifabric/core/src/components/DocumentCard/examples/DocumentCard.Image.Example.tsx') as string;
const DocumentCardConversationExampleCode = require('!raw-loader!@uifabric/core/src/components/DocumentCard/examples/DocumentCard.Conversation.Example.tsx') as string;
const DocumentCardConversationExampleCodepen = require('!@uifabric/codepen-loader!@uifabric/core/src/components/DocumentCard/examples/DocumentCard.Conversation.Example.tsx') as string;
...
export const DocumentCardPageProps: IDocPageProps = {
  ...
  overview: require<string>('!raw-loader!@uifabric/core/src/components/DocumentCard/docs/DocumentCardOverview.md'),
  bestPractices: '',
  dos: require<string>('!raw-loader!@uifabric/core/src/components/DocumentCard/docs/DocumentCardDos.md'),
  donts: require<string>('!raw-loader!@uifabric/core/src/components/DocumentCard/docs/DocumentCardDonts.md'),
