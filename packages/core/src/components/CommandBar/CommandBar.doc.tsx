...
const CommandBarBasicExampleCode = require('!raw-loader!@uifabric/core/src/components/CommandBar/examples/CommandBar.Basic.Example.tsx') as string;

const CommandBarButtonAsExampleCode = require('!raw-loader!@uifabric/core/src/components/CommandBar/examples/CommandBar.ButtonAs.Example.tsx') as string;

const IndividualCommandBarButtonAsExampleCode = require('!raw-loader!@uifabric/core/src/components/CommandBar/examples/CommandBar.CommandBarButtonAs.Example.tsx') as string;

const CommandBarSplitDisabledExampleCode = require('!raw-loader!@uifabric/core/src/components/CommandBar/examples/CommandBar.SplitDisabled.Example.tsx') as string;
...
export const CommandBarPageProps: IDocPageProps = {
  ...
  overview: require<string>('!raw-loader!@uifabric/core/src/components/CommandBar/docs/CommandBarOverview.md'),
  bestPractices: '',
  dos: require<string>('!raw-loader!@uifabric/core/src/components/CommandBar/docs/CommandBarDos.md'),
  donts: require<string>('!raw-loader!@uifabric/core/src/components/CommandBar/docs/CommandBarDonts.md'),
