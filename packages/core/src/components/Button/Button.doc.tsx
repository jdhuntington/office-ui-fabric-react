...
const ButtonActionExampleCode = require('!raw-loader!@uifabric/core/src/components/Button/examples/Button.Action.Example.tsx') as string;
const ButtonAnchorExampleCode = require('!raw-loader!@uifabric/core/src/components/Button/examples/Button.Anchor.Example.tsx') as string;
const ButtonCommandBarExampleCode = require('!raw-loader!@uifabric/core/src/components/Button/examples/Button.CommandBar.Example.tsx') as string;
const ButtonCompoundExampleCode = require('!raw-loader!@uifabric/core/src/components/Button/examples/Button.Compound.Example.tsx') as string;
const ButtonContextualMenuExampleCode = require('!raw-loader!@uifabric/core/src/components/Button/examples/Button.ContextualMenu.Example.tsx') as string;
const ButtonCustomSplitExampleCode = require('!raw-loader!@uifabric/core/src/components/Button/examples/Button.CustomSplit.Example.tsx') as string;
const ButtonDefaultExampleCode = require('!raw-loader!@uifabric/core/src/components/Button/examples/Button.Default.Example.tsx') as string;
const ButtonIconExampleCode = require('!raw-loader!@uifabric/core/src/components/Button/examples/Button.Icon.Example.tsx') as string;
const ButtonScreenReaderExampleCode = require('!raw-loader!@uifabric/core/src/components/Button/examples/Button.ScreenReader.Example.tsx') as string;
const ButtonSplitExampleCode = require('!raw-loader!@uifabric/core/src/components/Button/examples/Button.Split.Example.tsx') as string;
const ButtonToggleExampleCode = require('!raw-loader!@uifabric/core/src/components/Button/examples/Button.Toggle.Example.tsx') as string;
const ButtonCommandExampleCode = require('!raw-loader!@uifabric/core/src/components/Button/examples/Button.Command.Example.tsx') as string;
...
export const ButtonPageProps = (props: IButtonDocPageProps): IDocPageProps => ({
  ...
  overview: require<string>('!raw-loader!@uifabric/core/src/components/Button/docs/ButtonOverview.md'),
  dos: require<string>('!raw-loader!@uifabric/core/src/components/Button/docs/ButtonDos.md'),
  donts: require<string>('!raw-loader!@uifabric/core/src/components/Button/docs/ButtonDonts.md'),
