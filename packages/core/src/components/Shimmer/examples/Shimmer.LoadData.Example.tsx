...
import { Shimmer, ShimmerElementsGroup, ShimmerElementType } from '@uifabric/core/lib/Shimmer';
import { Persona, PersonaSize, PersonaPresence, IPersonaProps } from '@uifabric/core/lib/Persona';
