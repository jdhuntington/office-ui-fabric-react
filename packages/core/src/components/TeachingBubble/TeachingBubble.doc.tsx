...
const TeachingBubbleBasicExampleCode = require('!raw-loader!@uifabric/core/src/components/TeachingBubble/examples/TeachingBubble.Basic.Example.tsx') as string;
const TeachingBubbleCondensedExampleCode = require('!raw-loader!@uifabric/core/src/components/TeachingBubble/examples/TeachingBubble.Condensed.Example.tsx') as string;
const TeachingBubbleIllustrationExampleCode = require('!raw-loader!@uifabric/core/src/components/TeachingBubble/examples/TeachingBubble.Basic.Example.tsx') as string;
const TeachingBubbleWideIllustrationExampleCode = require('!raw-loader!@uifabric/core/src/components/TeachingBubble/examples/TeachingBubble.WideIllustration.Example.tsx') as string;
const TeachingBubbleSmallHeadlineExampleCode = require('!raw-loader!@uifabric/core/src/components/TeachingBubble/examples/TeachingBubble.SmallHeadline.Example.tsx') as string;
...
export const TeachingBubblePageProps: IDocPageProps = {
  ...
  overview: require<string>('!raw-loader!@uifabric/core/src/components/TeachingBubble/docs/TeachingBubbleOverview.md'),
  dos: require<string>('!raw-loader!@uifabric/core/src/components/TeachingBubble/docs/TeachingBubbleDos.md'),
  donts: require<string>('!raw-loader!@uifabric/core/src/components/TeachingBubble/docs/TeachingBubbleDonts.md'),
