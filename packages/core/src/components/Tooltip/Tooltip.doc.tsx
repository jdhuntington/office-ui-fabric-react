...
const TooltipBasicExampleCode = require('!raw-loader!@uifabric/core/src/components/Tooltip/examples/Tooltip.Basic.Example.tsx') as string;
const TooltipDisplayExampleCode = require('!raw-loader!@uifabric/core/src/components/Tooltip/examples/Tooltip.Display.Example.tsx') as string;
const TooltipBasicExampleCodepen = require('!@uifabric/codepen-loader!@uifabric/core/src/components/Tooltip/examples/Tooltip.Basic.Example.tsx') as string;
const TooltipCustomExampleCode = require('!raw-loader!@uifabric/core/src/components/Tooltip/examples/Tooltip.Custom.Example.tsx') as string;
const TooltipInteractiveExampleCode = require('!raw-loader!@uifabric/core/src/components/Tooltip/examples/Tooltip.Interactive.Example.tsx') as string;
const TooltipOverflowExampleCode = require('!raw-loader!@uifabric/core/src/components/Tooltip/examples/Tooltip.Overflow.Example.tsx') as string;
const TooltipNoScrollExampleCode = require('!raw-loader!@uifabric/core/src/components/Tooltip/examples/Tooltip.NoScroll.Example.tsx') as string;
const TooltipAbsolutePositionExampleCode = require('!raw-loader!@uifabric/core/src/components/Tooltip/examples/Tooltip.Absolute.Position.Example.tsx') as string;
...
export const TooltipPageProps: IDocPageProps = {
  ...
  overview: require<string>('!raw-loader!@uifabric/core/src/components/Tooltip/docs/TooltipOverview.md'),
