...
const ImageDefaultExampleCode = require('!raw-loader!@uifabric/core/src/components/Image/examples/Image.Default.Example.tsx') as string;
const ImageCenterExampleCode = require('!raw-loader!@uifabric/core/src/components/Image/examples/Image.Center.Example.tsx') as string;
const ImageContainExampleCode = require('!raw-loader!@uifabric/core/src/components/Image/examples/Image.Contain.Example.tsx') as string;
const ImageCoverExampleCode = require('!raw-loader!@uifabric/core/src/components/Image/examples/Image.Cover.Example.tsx') as string;
const ImageCenterContainExampleCode = require('!raw-loader!@uifabric/core/src/components/Image/examples/Image.CenterContain.Example.tsx') as string;
const ImageCenterCoverExampleCode = require('!raw-loader!@uifabric/core/src/components/Image/examples/Image.CenterCover.Example.tsx') as string;
const ImageNoneExampleCode = require('!raw-loader!@uifabric/core/src/components/Image/examples/Image.None.Example.tsx') as string;
const ImageMaximizeFrameExampleCode = require('!raw-loader!@uifabric/core/src/components/Image/examples/Image.MaximizeFrame.Example.tsx') as string;
...
export const ImagePageProps: IDocPageProps = {
  ...
  overview: require<string>('!raw-loader!@uifabric/core/src/components/Image/docs/ImageOverview.md'),
  bestPractices: '',
  dos: require<string>('!raw-loader!@uifabric/core/src/components/Image/docs/ImageDos.md'),
  donts: require<string>('!raw-loader!@uifabric/core/src/components/Image/docs/ImageDonts.md'),
