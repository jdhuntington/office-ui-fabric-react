...
import { IconButton, PrimaryButton } from '@uifabric/core/lib/Button';
import { Dialog, DialogFooter } from '@uifabric/core/lib/Dialog';
import { TextField, ITextField } from '@uifabric/core/lib/TextField';
