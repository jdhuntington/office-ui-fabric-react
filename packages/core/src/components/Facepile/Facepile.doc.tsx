...
const FacepileAddFaceExampleCode = require('!raw-loader!@uifabric/core/src/components/Facepile/examples/Facepile.AddFace.Example.tsx') as string;
const FacepileBasicExampleCode = require('!raw-loader!@uifabric/core/src/components/Facepile/examples/Facepile.Basic.Example.tsx') as string;
const FacepileOverflowExampleCode = require('!raw-loader!@uifabric/core/src/components/Facepile/examples/Facepile.Overflow.Example.tsx') as string;
...
export const FacepilePageProps: IDocPageProps = {
  ...
  overview: require<string>('!raw-loader!@uifabric/core/src/components/Facepile/docs/FacepileOverview.md'),
  bestPractices: '',
  dos: require<string>('!raw-loader!@uifabric/core/src/components/Facepile/docs/FacepileDos.md'),
  donts: require<string>('!raw-loader!@uifabric/core/src/components/Facepile/docs/FacepileDonts.md'),
