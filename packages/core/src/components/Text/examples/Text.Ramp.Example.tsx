...
import { IFontStyles } from '@uifabric/core/lib/Styling';
import { DetailsList, IColumn, DetailsListLayoutMode, SelectionMode, DetailsRow, IDetailsRowProps } from '@uifabric/core/lib/DetailsList';
