...
const CalloutBasicExampleCode = require('!raw-loader!@uifabric/core/src/components/Callout/examples/Callout.Basic.Example.tsx') as string;
const CalloutNestedExampleCode = require('!raw-loader!@uifabric/core/src/components/Callout/examples/Callout.Nested.Example.tsx') as string;
const CalloutFocusTrapExampleCode = require('!raw-loader!@uifabric/core/src/components/Callout/examples/Callout.FocusTrap.Example.tsx') as string;
const CalloutDirectionalExampleCode = require('!raw-loader!@uifabric/core/src/components/Callout/examples/Callout.Directional.Example.tsx') as string;
const CalloutCoverExampleCode = require('!raw-loader!@uifabric/core/src/components/Callout/examples/Callout.Cover.Example.tsx') as string;
...
export const CalloutPageProps: IDocPageProps = {
  ...
  overview: require<string>('!raw-loader!@uifabric/core/src/components/Callout/docs/CalloutOverview.md'),
  bestPractices: '',
  dos: require<string>('!raw-loader!@uifabric/core/src/components/Callout/docs/CalloutDos.md'),
  donts: require<string>('!raw-loader!@uifabric/core/src/components/Callout/docs/CalloutDonts.md'),
